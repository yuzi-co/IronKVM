  ...
  translation: {
    ...
    settings: {
      ...
      network: {
        ...
        ethernet: {
          title: 'IP-адреса',
          description: 'Налаштуйте, як NanoKVM отримує адресу в дротовій мережі',
          dhcp: 'DHCP',
          manual: 'Вручну',
          ...
          save: 'Застосувати',
          invalidAddress: 'Введіть коректну IP-адресу',
          invalidMask: 'Введіть коректну маску підмережі, наприклад 255.255.255.0 або 24',
          invalidRouter: 'Введіть коректну адресу маршрутизатора',
          addressRequired: 'Потрібна IP-адреса',
          maskRequired: 'Потрібна маска підмережі',
          applyTitle: 'Змінити адресу NanoKVM?',
          applyWarning:
            "З'єднання з цією сторінкою буде втрачено. NanoKVM застосує нову адресу та зачекає {{seconds}} секунд, поки ви дістанетеся до нього за цією адресою. Це збереже зміну. Якщо до нього ніщо не дістанеться, NanoKVM поверне попередні налаштування.",
          applyConfirm: 'Застосувати',
          applyCancel: 'Скасувати',
          applyFailed: 'Не вдалося застосувати адресу',
          trialTitle: 'Очікування підтвердження',
          trialDhcp: 'NanoKVM запитує адресу через DHCP.',
          trialStatic: 'NanoKVM тепер доступний за адресою {{address}}.',
          trialInstruction:
            'Відкрийте NanoKVM за його новою адресою та увійдіть, якщо він про це попросить. Це збереже зміну. Якщо до NanoKVM ніщо не дістанеться за {{seconds}} секунд, він поверне попередні налаштування.',
          trialOpen: 'Відкрити нову адресу',
          trialKeep: 'Зберегти ці налаштування',
          trialKept: 'Нову адресу збережено',
          trialKeepFailed: 'Не вдалося зберегти налаштування',
          trialGone: 'Зміну вже скасовано. Спробуйте ще раз.',
