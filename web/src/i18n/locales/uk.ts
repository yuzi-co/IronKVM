    ...
    settings: {
      ...
      network: {
        ...
        ethernet: {
          ...
          applyWarning:
            "З'єднання з цією сторінкою буде втрачено. NanoKVM застосує нову адресу, а потім зачекає {{seconds}} секунд на ваше підтвердження з нової адреси. Без підтвердження NanoKVM поверне попередні налаштування.",
          ...
          trialInstruction:
            'Відкрийте NanoKVM за новою адресою, увійдіть і поверніться сюди, щоб зберегти зміну. NanoKVM поверне попередні налаштування через {{seconds}} секунд.',
