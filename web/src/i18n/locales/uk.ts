    ...
    settings: {
      ...
      network: {
        ...
        ethernet: {
          ...
          applyWarning:
            "З'єднання з цією сторінкою буде втрачено. NanoKVM застосує нову адресу, а потім зачекає {{seconds}} секунд, поки ви відкриєте його за цією адресою та увійдете. Якщо до нього ніхто не дістанеться, NanoKVM поверне попередні налаштування.",
          ...
          trialInstruction:
            'Відкрийте NanoKVM за його новою адресою та увійдіть. Це збереже зміну. Якщо до NanoKVM ніхто не дістанеться за {{seconds}} секунд, він поверне попередні налаштування.',
