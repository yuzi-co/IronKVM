    ...
    settings: {
      ...
      network: {
        ...
        ethernet: {
          ...
          applyWarning:
            'Соединение с этой страницей будет потеряно. NanoKVM применит новый адрес и подождёт {{seconds}} секунд вашего подтверждения с нового адреса. Без подтверждения NanoKVM вернёт прежние настройки.',
          ...
          trialInstruction:
            'Откройте NanoKVM по новому адресу, войдите и вернитесь сюда, чтобы сохранить изменение. NanoKVM вернёт прежние настройки через {{seconds}} секунд.',
