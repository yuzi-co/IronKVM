  ...
  translation: {
    ...
    settings: {
      ...
      network: {
        ...
        ethernet: {
          title: 'IP-адрес',
          description: 'Настройте, как NanoKVM получает адрес в проводной сети',
          dhcp: 'DHCP',
          manual: 'Вручную',
          ...
          save: 'Применить',
          invalidAddress: 'Введите корректный IP-адрес',
          invalidMask: 'Введите корректную маску подсети, например 255.255.255.0 или 24',
          invalidRouter: 'Введите корректный адрес маршрутизатора',
          addressRequired: 'Требуется IP-адрес',
          maskRequired: 'Требуется маска подсети',
          applyTitle: 'Изменить адрес NanoKVM?',
          applyWarning:
            'Соединение с этой страницей будет потеряно. NanoKVM применит новый адрес и подождёт {{seconds}} секунд, пока вы доберётесь до него по этому адресу. Это сохранит изменение. Если до него ничего не доберётся, NanoKVM вернёт прежние настройки.',
          applyConfirm: 'Применить',
          applyCancel: 'Отмена',
          applyFailed: 'Не удалось применить адрес',
          trialTitle: 'Ожидание подтверждения',
          trialDhcp: 'NanoKVM запрашивает адрес по DHCP.',
          trialStatic: 'NanoKVM теперь доступен по адресу {{address}}.',
          trialInstruction:
            'Откройте NanoKVM по новому адресу и войдите, если он это запросит. Это сохранит изменение. Если до NanoKVM ничего не доберётся за {{seconds}} секунд, он вернёт прежние настройки.',
          trialOpen: 'Открыть новый адрес',
          trialKeep: 'Сохранить эти настройки',
          trialKept: 'Новый адрес сохранён',
          trialKeepFailed: 'Не удалось сохранить настройки',
          trialGone: 'Изменение уже отменено. Попробуйте ещё раз.',
