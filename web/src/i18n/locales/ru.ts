    ...
    settings: {
      ...
      network: {
        ...
        ethernet: {
          ...
          applyWarning:
            'Соединение с этой страницей будет потеряно. NanoKVM применит новый адрес и подождёт {{seconds}} секунд, пока вы откроете его по этому адресу и войдёте. Если до него никто не доберётся, NanoKVM вернёт прежние настройки.',
          ...
          trialInstruction:
            'Откройте NanoKVM по новому адресу и войдите. Это сохранит изменение. Если до NanoKVM никто не доберётся за {{seconds}} секунд, он вернёт прежние настройки.',
