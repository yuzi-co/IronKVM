    ...
    settings: {
      ...
      network: {
        ...
        ethernet: {
          ...
          applyWarning:
            'La connessione a questa pagina andrà persa. NanoKVM applica il nuovo indirizzo, poi attende {{seconds}} secondi la tua conferma dal nuovo indirizzo. Senza conferma, NanoKVM ripristina le impostazioni precedenti.',
          ...
          trialInstruction:
            'Apri NanoKVM al suo nuovo indirizzo, accedi e torna qui per mantenere la modifica. NanoKVM ripristina le impostazioni precedenti tra {{seconds}} secondi.',
