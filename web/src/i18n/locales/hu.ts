    ...
    settings: {
      ...
      network: {
        ...
        ethernet: {
          ...
          applyWarning:
            'Az oldallal való kapcsolat megszakad. A NanoKVM alkalmazza az új címet, majd {{seconds}} másodpercet vár arra, hogy megerősítse azt az új címről. Megerősítés nélkül a NanoKVM visszaállítja a korábbi beállításokat.',
          ...
          trialInstruction:
            'Nyissa meg a NanoKVM-et az új címén, jelentkezzen be, majd térjen ide vissza a módosítás megtartásához. A NanoKVM {{seconds}} másodperc múlva visszaállítja a korábbi beállításokat.',
