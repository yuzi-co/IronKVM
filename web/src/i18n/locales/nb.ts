    ...
    settings: {
      ...
      network: {
        ...
        ethernet: {
          ...
          applyWarning:
            'Forbindelsen til denne siden går tapt. NanoKVM tar i bruk den nye adressen og venter deretter {{seconds}} sekunder på bekreftelsen din fra den nye adressen. Uten bekreftelse gjenoppretter NanoKVM de forrige innstillingene.',
          applyConfirm: 'Bruk',
          applyCancel: 'Avbryt',
          ...
          trialInstruction:
            'Åpne NanoKVM på den nye adressen, logg inn, og kom tilbake hit for å beholde endringen. NanoKVM gjenoppretter de forrige innstillingene om {{seconds}} sekunder.',
