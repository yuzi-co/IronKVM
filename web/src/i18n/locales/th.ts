    ...
    settings: {
      ...
      network: {
        ...
        ethernet: {
          ...
          applyWarning:
            'การเชื่อมต่อกับหน้านี้จะขาดหาย NanoKVM จะใช้ที่อยู่ใหม่ แล้วรอ {{seconds}} วินาทีให้คุณยืนยันจากที่อยู่ใหม่ หากไม่ยืนยัน NanoKVM จะคืนค่าการตั้งค่าเดิม',
          applyConfirm: 'ใช้งาน',
          applyCancel: 'ยกเลิก',
          ...
          trialInstruction:
            'เปิด NanoKVM ที่ที่อยู่ใหม่ ลงชื่อเข้าใช้ แล้วกลับมาที่นี่เพื่อเก็บการเปลี่ยนแปลงไว้ NanoKVM จะคืนค่าการตั้งค่าเดิมใน {{seconds}} วินาที',
