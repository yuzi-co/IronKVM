    ...
    settings: {
      ...
      network: {
        ...
        ethernet: {
          ...
          router: 'เราเตอร์',
          save: 'ใช้งาน',
          invalidAddress: 'โปรดป้อนที่อยู่ IP ที่ถูกต้อง',
          invalidMask: 'โปรดป้อนซับเน็ตมาสก์ที่ถูกต้อง เช่น 255.255.255.0 หรือ 24',
          ...
          applyWarning:
            'การเชื่อมต่อกับหน้านี้จะขาดหาย NanoKVM จะใช้ที่อยู่ใหม่ แล้วรอ {{seconds}} วินาทีให้คุณเปิดที่อยู่นั้นและลงชื่อเข้าใช้ หากไม่มีใครเข้าถึงได้ NanoKVM จะคืนค่าการตั้งค่าก่อนหน้า',
          applyConfirm: 'ใช้งาน',
          applyCancel: 'ยกเลิก',
          ...
          trialInstruction:
            'เปิด NanoKVM ที่อยู่ใหม่แล้วลงชื่อเข้าใช้ การทำเช่นนี้จะเก็บการเปลี่ยนแปลงไว้ หากไม่มีใครเข้าถึง NanoKVM ภายใน {{seconds}} วินาที ระบบจะคืนค่าการตั้งค่าก่อนหน้า',
          trialOpen: 'เปิดที่อยู่ใหม่',
          trialKeep: 'เก็บการตั้งค่านี้ไว้',
          trialKept: 'บันทึกที่อยู่ใหม่แล้ว',
          trialKeepFailed: 'เก็บการตั้งค่าไม่สำเร็จ',
          trialGone: 'การเปลี่ยนแปลงถูกคืนค่าไปแล้ว โปรดลองอีกครั้ง',
